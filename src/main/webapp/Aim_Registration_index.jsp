...
<title>Register Index File</title>
...
<style>
 ...
 <header>
        <h2>Registration - AIM IT Institute</h2>
    </header>
<nav>
        <ul>
...
<body class="bg-#ffff">
    ...
    <div class="col-6 d2 form" >
              <center>  <img src="Aim_logo.png" height="190px" width="320px"><br><br>
                <h4>Look like you're new here!<br><br>Register here to get started.<br></h4><br><br>
               </center>
            </div>
        <div class="card p-4 shadow" style="width: 400px;">
            <h3 class="text-center mb-4">Register</h3>
            <form action="Aim_Register_Process.jsp" method="post">
                <div class="mb-3">
